# "Waiting for Godot" by Samuel Beckett   [B2]
...
![](Waiting%20for%20Godot%20by%20Samuel%20Beckett.webp)
...
Waiting for Godot is a [play](## "opera teatrale") by Irish author Samuel Beckett, written [in the late 1940s](## "alla fine degli anni Quaranta") and first performed in 1953. The work is a tragicomedy in the absurdist genre. It explores the human condition, the search for meaning in life, the cyclical nature of time, and the futility of existence.

## WAITING
Performed in two acts, Beckett’s first professionally-produced [play](## "opera teatrale") is about two apparently homeless men, Vladimir and Estragon, who wait by a tree in a deserted location for a mysterious man named Godot. But who or what is Godot, and why are the men waiting for him? 
...
## EXISTENTIALISM
As Vladimir and Estragon continue to wait, two new characters arrive: Pozzo and his [mistreated](## "maltrattare") slave, Lucky. While the characters seem to inhabit a confusing and imaginary world, the dialogue and word[play](## "opera teatrale") are magical and poetic. Originally written in French — Beckett lived in France for most of his adult life — the minimalist script captures the existential [angst](## "angoscia, inquietudine") of post-World War Two Europe. 
...
## PASSING TIME
In Act II, with Vladimir and Estragon looking to Godot as an [embodiment](## "incarnazione") of hope or salvation, a boy delivers a message that Godot has been [delayed](## "ritardare") Vladimir suggests that the boy has been here before, with a similar message, in Act I. But no one seems to remember. Nothing is certain, [least of all](## "tanto meno") the movement of time. 
...
## REPETITION
[Throughout](## "per tutto il tempo") Waiting for Godot, all of the characters are [stuck](## "atrapados") in a [seemingly](## "apparentemente") [pointless](## "privo di senso") cycle of waiting. Rather than taking action — doing something — they are [disabled](## "rendere incapace") by a sense of [hopelessness](## "mancanza di speranza"). Passive and accepting of their [fate](## "destino"), Vladimir and Estragon await the vague promise of external redemption in the shape of Godot to provide meaning and [purpose](## "scopo") to their lives. Life is symbolised by a circular and repetitive [refrain](## "ritornello, espressione ricorrente"):
“ESTRAGON: Let’s go.
VLADIMIR: We can’t.
ESTRAGON: Why not?
...
## KNOWING GODOT
Waiting for Godot initially received [mixed reviews](## "recensioni discordanti"), with critics and audiences hostile to its nihilism, [nonsense](## "assurdità") and depiction of life’s [meaninglessness](## "insensatezza"). It has since become one of the theatre’s best-loved and most-analysed productions. Beckett himself remained tight-lipped about the meaning of his drama, preferring to let the work speak for itself. However, in letters to friends written in the 1950s, he wrote, “I do not know who Godot is. I do not even know if he exists.” One of the most influential writers of the 20th century, Beckett was awarded the 1969 Nobel Prize in Literature.  
 
